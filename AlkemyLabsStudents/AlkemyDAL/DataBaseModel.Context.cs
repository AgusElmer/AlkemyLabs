...
namespace AlkemyDAL
{
    ...
    public partial class alkemylabsEntities : DbContext
    {
        ...
        public virtual DbSet<classes_registry> classes_registry { get; set; }
        public virtual DbSet<professors_table> professors_table { get; set; }
        public virtual DbSet<students> students { get; set; }
    
        public virtual int delete_class(Nullable<int> pclass_code, string class_name, Nullable<int> pclass_quota, Nullable<int> pfull_quota, Nullable<int> pclass_schedule, Nullable<int> pclass_professor_dni, Nullable<int> retVal)
        {
            ...
            var pclass_professor_dniParameter = pclass_professor_dni.HasValue ?
                new ObjectParameter("pclass_professor_dni", pclass_professor_dni) :
                new ObjectParameter("pclass_professor_dni", typeof(int));
    
            var retValParameter = retVal.HasValue ?
                new ObjectParameter("RetVal", retVal) :
                new ObjectParameter("RetVal", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("delete_class", pclass_codeParameter, class_nameParameter, pclass_quotaParameter, pfull_quotaParameter, pclass_scheduleParameter, pclass_professor_dniParameter, retValParameter);
        }
        ...
        public virtual int insert_class(Nullable<int> pclass_code, Nullable<int> pclass_professor_dni, Nullable<int> pclass_quota, Nullable<System.DateTime> pclass_schedule, string pclass_name, Nullable<int> retval)
        {
            var pclass_codeParameter = pclass_code.HasValue ?
                new ObjectParameter("pclass_code", pclass_code) :
                new ObjectParameter("pclass_code", typeof(int));
            ...
            var pclass_scheduleParameter = pclass_schedule.HasValue ?
                new ObjectParameter("pclass_schedule", pclass_schedule) :
                new ObjectParameter("pclass_schedule", typeof(System.DateTime));
    
            var pclass_nameParameter = pclass_name != null ?
                new ObjectParameter("pclass_name", pclass_name) :
                new ObjectParameter("pclass_name", typeof(string));
    
            var retvalParameter = retval.HasValue ?
                new ObjectParameter("Retval", retval) :
                new ObjectParameter("Retval", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("insert_class", pclass_codeParameter, pclass_professor_dniParameter, pclass_quotaParameter, pclass_scheduleParameter, pclass_nameParameter, retvalParameter);
        }
    
        public virtual int insert_professor(Nullable<int> pprofessor_ID, string pprofessor_name, string pprofesor_last_name, Nullable<int> retval)
        {
            var pprofessor_IDParameter = pprofessor_ID.HasValue ?
                new ObjectParameter("pprofessor_ID", pprofessor_ID) :
                new ObjectParameter("pprofessor_ID", typeof(int));
            ...
            var pprofesor_last_nameParameter = pprofesor_last_name != null ?
                new ObjectParameter("pprofesor_last_name", pprofesor_last_name) :
                new ObjectParameter("pprofesor_last_name", typeof(string));
    
            var retvalParameter = retval.HasValue ?
                new ObjectParameter("Retval", retval) :
                new ObjectParameter("Retval", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("insert_professor", pprofessor_IDParameter, pprofessor_nameParameter, pprofesor_last_nameParameter, retvalParameter);
        }
